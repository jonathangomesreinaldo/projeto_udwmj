...
class ConsultingTab extends StatefulWidget {
  ...
  ConsultingTabState createState() {
    return ConsultingTabState();
  }
}

class ConsultingTabState extends State<ConsultingTab> {
  Mensagem msg;
  @override
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBar(
          ...
          backgroundColor: Color.fromARGB(255, 84, 11, 14),
        ),
        body: ListView(children: <Widget>[
          ...
          Container(
            ...
            color: Color.fromARGB(100, 158, 42, 43),
            child: ListTile(
              leading: Image(
                image: NetworkImage(
